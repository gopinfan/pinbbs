                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="captcha" type="text" class="form-control{{ $errors->has('captcha') ? ' is-invalid' : '' }}" name="captcha" required autocomplete="off">

                                <img class="thumbnail mt-2 cursor-pointer" src="{{captcha_src('flat')}}" alt="验证码" title="点击图片刷新验证码" onclick="this.src='/captcha/flat?'+Math.random()">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary px-4">注册</button>
                            </div>
                        </div>
                    </form>
                </div>
